...
public class DbManager {
    ...
    private static class DbHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL(DbSchema.Table_Currency.CREATE_TABLE);
            db.execSQL(DbSchema.Table_Expensescategories.CREATE_TABLE);
            db.execSQL(DbSchema.Table_Category.CREATE_TABLE);
        }

        @Override
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            db.execSQL(DbSchema.Table_Currency.DROP_TABLE);
            db.execSQL(DbSchema.Table_Expensescategories.DROP_TABLE);
